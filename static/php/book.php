                ...
                <div class="container">
                    <ul class="nav nav-tabs">
                        <li class="<?php echo $book == 0 ? 'active' : ''; ?>"><a data-toggle="tab" href="#flight"><i class="flaticon-plane"></i>
                                Flight</a></li>
                        <li class="<?php echo $book == 1 ? 'active' : ''; ?>"><a data-toggle="tab" href="#hotel"><i class="flaticon-resort"></i> Hotel</a></li>
                        <li class="<?php echo $book == 2 ? 'active' : ''; ?>"><a data-toggle="tab" href="#car"><i class="flaticon-car"></i> Car Rent</a></li>
