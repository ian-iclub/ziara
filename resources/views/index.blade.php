...
<!-- Ommitted -->
<div id="joc-services" style="display:none">
    <div class="container">
...
<div id="joc-blog" style="display:none">
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 text-center joc-heading animate-box">
                <h2>Recent Blog</h2>
...
<div id="joc-intro" class="intro-img" style="background-image: url(images/cover-img-1.jpg);display:none;"
        ...
        <div class="row">
                    ...
                    <div class="text-salebox">
                        ...
                        <div class="text-rights">
                            ...
                            <p>Separated they live in Bookmarksgrove right at the coast of the Semantics, a large
                                language ocean.</p>
                            <p><a href="#" class="btn btn-primary">Book Now</a> <a href="#" class="btn btn-primary btn-outline">Read
                                    more</a></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 animate-box">
                <div class="video-wrap">
                    <div class="video joc-video" style="background-image: url(images/img_bg_2.jpg);">
...
<div id="joc-hotel" style="display:none">
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 text-center joc-heading animate-box">
                        ...
                        <div class="hotel-entry">
                            ...
                            <div class="desc">
                                <p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i
                                            class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span>
                                    545 Reviews</p>
...
<div id="joc-testimony" class="joc-light-grey" style="display:none">
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 text-center joc-heading animate-box">
...
<div class="joc-tour" style="display:none">
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 text-center joc-heading animate-box">
...
<div id="joc-subscribe" style="display:none;background-image: url(images/img_bg_2.jpg);"
    data-stellar-background-ratio="0.5">
    <div class="overlay"></div>
    <div class="container">
        <div class="row">
